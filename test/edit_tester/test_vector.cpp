...
static void default_constructor(void)
{
	...
	TEST_NAME::vector<int> v1;
	TEST_NAME::vector<int> v2;
	check("v1 == v2", v1 == v2);
	v1.push_back(1);
	v1.push_back(2);
	v1.push_back(3);
...
static void copy_constructor(void)
{
	...
	v2.push_back(2);
	v2.push_back(3);
	TEST_NAME::vector<int> v3(v1);
	TEST_NAME::vector<int> v4(v2);
	v1.push_back(42);
	v2.push_back(42);
	check("v1 == v2", (v1 == v2));
	check("v3 == v4", (v3 == v4));
...
static void max_size(void)
{
	...
	TEST_NAME::vector<std::string> v1;
	TEST_NAME::vector<std::string> v2;
...
static void swap(void)
{
	...
	TEST_NAME::vector<int> v1;
	TEST_NAME::vector<int> v2;
	TEST_NAME::vector<int> v3;
	TEST_NAME::vector<int> v4;
	v1.push_back(1);
	v1.push_back(2);
	v1.push_back(3);
	v2.push_back(1);
